...
void UTargetDataUnderMouse::Activate()
{
	...
	else 
	{
		...
		const FPredictionKey ActPredKey = GetActivationPredictionKey();
		...
		const bool bCalledDelegate = AbilitySystemComponent.Get()->CallReplicatedTargetDataDelegatesIfSet(SpecHandle, ActPredKey);
